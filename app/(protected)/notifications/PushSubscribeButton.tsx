  ...
  return (
    <div className="card" style={{ padding: 18 }}>
      ...
      <p style={{ color: "var(--muted)", fontSize: 14, marginBottom: 14 }}>
        Receive notifications in your browser even when you&apos;re not on this
        page.
      </p>

      {status === "denied" ? (
        <p style={{ color: "var(--muted)", fontSize: 14, margin: 0 }}>
          Push notifications are blocked. Enable them in your browser&apos;s
      ...
      {error && (
        <p
          style={{ color: "red", fontSize: 13, marginTop: 8, marginBottom: 0 }}
        >
          {error}
        </p>
      )}
